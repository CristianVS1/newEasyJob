 ...
 */
package edu.sena.utility.neweasyjob;
 ...
 * @author user
 */
@WebServlet("/imagesPrd/*")
public class ServletImgProd extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!filename.isEmpty()) {
            ...
            File carpeta = new File("C:\\Users\\user\\Documents\\NetBeansProjects\\ImgnewEasyJob\\Fotos\\Productos\\"+filename);
            ...
            try {
                ...
                System.out.println("edu.sena.utility.neweasyjob.ServletImg.doGet()");
            }
        }
    }
