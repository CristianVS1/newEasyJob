...
public abstract class Mail {
    ...
    public static void recuperarClave(String nombreUsuario,  String correoPara, String claveNueva) {
        final String usuario = "easyjob0909@gmail.com";
        final String clave = "easyjob1234";
